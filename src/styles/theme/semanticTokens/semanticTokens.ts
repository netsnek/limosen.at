...
import smtCalloutComponent from '../../../components/docs/callout/styles/callout';
import smtCodeSnippetComponent from '../../../components/docs/code-snippet/styles/codeSnippet';
import smtDrawerComponent from './components/drawer';
import smtFilesystemComponent from '../../../components/docs/filesystem/styles/filesystem';
import smtHeadingComponent from './components/heading';
import smtIconCardComponent from '../../../components/docs/icon-card/styles/iconCard';
import smtImageCardComponent from '../../../components/docs/image-card/styles/imageCard';
...
import smtcodeResultPreviewComponent from '../../../components/docs/code-result-preview/styles/codeResultPreview';
