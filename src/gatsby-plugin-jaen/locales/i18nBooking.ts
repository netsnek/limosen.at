...
export function getI18nBooking(code: I18nCode) {
  if (code === 'de-AT') {
    return {
      ...
      strings: {
        ...
        LabelEmail: 'E-Mail',
        LabelPhone: 'Telefon',
        PhoneNeedsCountry: 'Bitte mit Landesvorwahl',
  ...
  if (code === 'tr-TR') {
    return {
      ...
      strings: {
        ...
        PickupInPast: 'Alış saati geçmişte kaldı',
        ...
        LabelEmail: 'E-posta',
        LabelPhone: 'Telefon',
        PhoneNeedsCountry: 'Lütfen ülke kodunu girin',
  ...
  if (code === 'ar-EG') {
    return {
      ...
      strings: {
        ...
        LabelPhone: 'الهاتف',
        PhoneNeedsCountry: 'يرجى إدخال رمز الدولة',
  ...
  return {
    ...
    strings: {
      ...
      LabelEmail: 'Email',
      LabelPhone: 'Phone',
      PhoneNeedsCountry: 'Please enter the country code',
