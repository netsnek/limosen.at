...
const Heading: FC<IHeadingProps> = ({
  ...
  return (
    <ChakraHeading
       ...
       */
      // Cast for the same reason as the button variants in Content.tsx: the
      // site's heading recipe adds h1..h6, but nothing runs `chakra typegen`
      // here, so the prop still advertises v3's built-in union.
      size={variant as ChakraHeadingProps['size']}
