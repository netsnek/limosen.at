 ...
 * Tabler icon: `apple`.
 */
const TbApple = (props: IconProps) => (
  <Icon asChild={false} boxSize="1em" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
