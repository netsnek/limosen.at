...
export function getI18nHomepage(code: I18nCode) {
      ...
      switch (v.id) {
        ...
        case 'first-class-sedan':
          return {
            ...
            description: 'Mercedes Benz S500L 4Matic',
            image: v.image,
            passengers: v.passengers,
            luggage: v.luggage
          };
    ...
    const footer = [
      ...
      },
      {
        ...
        links: [
          ...
          { label: 'Künye', href: 'https://limosen.at/de/page/imprint' },
          { label: 'Gizlilik', href: 'https://limosen.at/de/page/privacy' }
        ]
      },
      {
        title: 'İletişim',
    ...
    const footer = [
      ...
      },
      {
        ...
        links: [
          ...
          {
            label: 'بيانات الناشر',
            href: 'https://limosen.at/de/page/imprint'
          },
          { label: 'الخصوصية', href: 'https://limosen.at/de/page/privacy' }
        ]
      },
      {
        title: 'التواصل',
  ...
  const fleet = FLEET_BASE.map(v => {
    switch (v.id) {
      case 'business-sedan':
        return {
          name: 'Mercedes Benz E Klasse or BMW 5',
          category: 'Business Class',
          description: '',
          image: v.image,
          passengers: v.passengers,
      ...
      case 'electric-sedan':
        return {
          name: 'Mercedes EQE Klasse or BMW i5',
          category: 'Electric Class',
          description: '',
          image: v.image,
          passengers: v.passengers,
  ...
  const footer = [
    ...
    },
    {
      ...
      links: [
        ...
        { label: 'Imprint', href: 'https://limosen.at/de/page/imprint' },
        { label: 'Privacy', href: 'https://limosen.at/de/page/privacy' }
      ]
    },
    {
      title: 'Contact',
